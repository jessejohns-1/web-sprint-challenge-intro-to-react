...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
 From my understanding React is an opensource javascript library. It's used to build out a dom from within a js.

 
1. Describe component state.
   State is a javaScript Object holding data that affects rendering and i's managed within a component. just like varbiales being delcared in a function

1. Describe props.
  Props stands for Properties which is what it sends to the component
